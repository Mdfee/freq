...
class NOTankAi_15com(IStrategy):
    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:
        ...
        df.loc[
            (
                ...
                & (df["volume"] > 0)  # Volume maior que 0
                & (df["rsi"] < 28)  # RSI abaixo de 30 (condição adicional para limitar entradas)
            ),
            ["enter_long", "enter_tag"],
        ] = (1, "Minima Check")
        ...
        df.loc[
            (
                ...
                & (df["volume"] > 0)  # Volume maior que 0
                & (df["rsi"] > 67)  # RSI acima de 70 (condição adicional para limitar entradas)
            ),
